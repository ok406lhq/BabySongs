...
import com.cool.music.adapter.user.ManMySheetMusicAdapter;
 ...
 * 这个类用于操作首页
 */
public class ManMyFragment extends Fragment {
    View rootview;
    String account=null;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootview = inflater.inflate(R.layout.frame_user_man_my, container, false);
    ...
    private void loadMyMessage() {
        ...
        //查询列表信息
        List<SheetBean> list = SheetDao.getSheet();
        listDe = rootview.findViewById(R.id.user_my_recyclerView);
        ManMySheetMusicAdapter de=new ManMySheetMusicAdapter(list);//适配器
